...
class __TwigTemplate_d5b5108c194e4bdd849aa7758149d140bcdc3edcd85c005c9e1732934c54de34 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <div class=\"intro__top\">
    ...
    <div class=\"intro__image-block\">
      <img src=\"./static/images/pages/home/book.png\" srcset=\"./static/images/pages/home/book.png 1x, ./static/images/pages/home/book@2x.png 2x\" alt=\"Jim Detert's book, 'Choosing Courage: The Everyday Guide to Being Brave at Work'\">
    </div>
  </div>
  <div class=\"intro__bottom\">
    <div class=\"intro__order-text\">
      ...
      <div class=\"intro__order-text-date\">";
        // line 41
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["quick_links_display_title"] ?? null), 41, $this->source), "html", null, true);
        echo "</div>
    </div>
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["subentity"]) {
            if ((twig_first($this->env, $context["key"]) != "#")) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4 = (($__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144 = twig_get_attribute($this->env, $this->source, $context["subentity"], "options", [], "any", false, false, true, 45)) && is_array($__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144) || $__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144 instanceof ArrayAccess ? ($__internal_62824350bc4502ee19dbc2e99fc6bdd3bd90e7d8dd6e72f42c35efd048542144["attributes"] ?? null) : null)) && is_array($__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4) || $__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4 instanceof ArrayAccess ? ($__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4["target"] ?? null) : null), 45, $this->source), "html", null, true);
                echo "\" href=\"";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["subentity"], "url", [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
                echo "\">";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["subentity"], "title", [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
                echo "</a>
      ";
            }
        }
  ...
  ";
    ...
    {
        return array (  140 => 47,  126 => 45,  121 => 44,  115 => 41,  101 => 30,  97 => 29,  89 => 24,  82 => 20,  78 => 19,  72 => 16,  68 => 15,  63 => 14,  61 => 11,  58 => 10,  56 => 9,  54 => 8,  51 => 7,  49 => 6,  47 => 5,  45 => 4,  43 => 3,  41 => 2,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% set display_title = eck_entity.field_display_title.getValue().0.value %}
{% set description = eck_entity.field_description.getValue().0.value|raw %}
{% set links = eck_entity.field_quick_links %}
{% set quick_links_display_title = eck_entity.field_quick_links_title.value %}
{% set image_url = eck_entity.field_background_image.entity.uri.value %}
{% set image_alt = eck_entity.field_background_image.entity.uri.value %}
...
<div{{ attributes.addClass(classes) }}>
  ...
  <div class=\"intro__top\">
    ...
    <div class=\"intro__button-block\">
      <div class=\"intro__download-button\">
        <a href=\"{{ download_link_url }}\" target=\"_blank\">
          <i class=\"icon-download\"></i>
        </a>
      </div>
      <span class=\"intro__button-text\">
  ...
  <div class=\"intro__bottom\">
    <div class=\"intro__order-text\">
      <div class=\"intro__order-text-heading\">pre-order</div>
      <div class=\"intro__order-text-date\">{{ quick_links_display_title }}</div>
    </div>
    <div class=\"intro__stores-list\">
      {% for key,subentity in links if key|first != '#' %}
        <a class=\"btn btn_primary\" target=\"{{ subentity.options['attributes']['target'] }}\" href=\"{{ subentity.url}}\">{{ subentity.title }}</a>
      {% endfor %}
    </div>
  </div>
</div>
  ...
  ", "themes/custom/actadigitech/templates/component/banner/eck-entity--component--banner_content.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\themes\\custom\\actadigitech\\templates\\component\\banner\\eck-entity--component--banner_content.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 1, "for" => 44);
        static $filters = array("raw" => 2, "escape" => 14, "first" => 44);
