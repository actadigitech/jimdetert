...
class __TwigTemplate_9b8dba6c32d50dcfeb63d3ebc0292a1db22ebbc21356b5bcc2d0a23d6c231c00 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html ";
  ...
  <body";
        // line 65
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["body_classes"] ?? null)], "method", false, false, true, 65), "addClass", [0 => ($context["class"] ?? null)], "method", false, false, true, 65), "setAttribute", [0 => "id", 1 => ($context["id"] ?? null)], "method", false, false, true, 65), 65, $this->source), "html", null, true);
        echo ">
...
";
    ...
    {
        return new Source("", "themes/custom/actadigitech/templates/system/html.html.twig", "/var/www/html/jimdetert/web/themes/custom/actadigitech/templates/system/html.html.twig");
    }
