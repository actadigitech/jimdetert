...
/* themes/custom/actadigitech/templates/menu/menu--footer-menu.html.twig */
class __TwigTemplate_ac6e3b19372928a87bfb7e7f4094a5b2d4341c2ecc493ee817d0ecdd600cf665 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_menu_links($__items__ = null, $__attributes__ = null, $__menu_level__ = null, $__classes__ = null, $__dropdown_classes__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                // line 24
                echo "    <ul";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => (((($context["menu_level"] ?? null) == 0)) ? (($context["classes"] ?? null)) : (($context["dropdown_classes"] ?? null)))], "method", false, false, true, 24), "addClass", [0 => "main_menu unstyled flex_item s_2"], "method", false, false, true, 24), "removeClass", [0 => "nav"], "method", false, false, true, 24), 24, $this->source), "html", null, true);
                echo ">
    ";
                // line 25
...
$context["loop"], "first", [], "any", false, false, true, 33)) ? ("first s_col_top flush_with_top_of_letters") : ("")), 3 => ((twig_get_attribute($this->env, $this->source,                     // line 34
$context["loop"], "last", [], "any", false, false, true, 34)) ? ("last s_last") : (""))];
                    // line 37
                    echo "      <li";
  ...
  ";
    ...
    {
        return "themes/custom/actadigitech/templates/menu/menu--footer-menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level, classes, dropdown_classes) %}
  {% if items %}
    <ul{{ attributes.addClass(menu_level == 0 ? classes : dropdown_classes).addClass('main_menu unstyled flex_item s_2').removeClass('nav') }}>
    {% for item in items %}
      {%
      ...
      {%
        set item_classes = [
          ...
          loop.first ? 'first s_col_top flush_with_top_of_letters',
          loop.last ? 'last s_last',
        ]
      %}
...
", "themes/custom/actadigitech/templates/menu/menu--footer-menu.html.twig", "/var/www/html/jimdetert/web/themes/custom/actadigitech/templates/menu/menu--footer-menu.html.twig");
    }
