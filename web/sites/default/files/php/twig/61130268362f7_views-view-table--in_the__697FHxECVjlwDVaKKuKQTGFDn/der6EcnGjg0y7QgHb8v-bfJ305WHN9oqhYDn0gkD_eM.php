...
class __TwigTemplate_26a418457da300a587be174c521bcfd3da09e70271605dc99ff4aff7bdd37500 extends \Twig\Template
{
    private $source;
    private $macros = [];
                    ...
                    {% for key,row in rows  %}
                        <li class=\"article__item\" style=\"opacity: 1;\">
                            <div class=\"article__row df-row\">
                                <div class=\"image_column col-sm-3 col-md-4\">
                                    <div class=\"logo-holder\">
                                        <img src=\"{{ row.columns.field_news_image.content }}\" alt=\"\">
                                    </div>
                                </div>
                                <div class=\"text_column col-sm-9 col-md-8\">
                                    <div class=\"article__top\">
                                        <span class=\"article__name\">{{ row.columns.field_tag_line.content }}</span>
                                        <span>&nbsp;|&nbsp;</span>
                                        <span class=\"article__time\"><time>{{ row.columns.field_date.content }}</time></span>
                                    </div>
                                    <h3 class=\"article__heading\">
                                        {{ row.columns.title.content }}
                                    </h3>
                                    <span class=\"author\">{{ row.columns.field_sub_title.content }}</span>
                                </div>
                            </div>
                        </li>
                    {% endfor %}
...
</section>", "themes/custom/actadigitech/templates/component/dynamic_content/news_insights/views-view-table--in_the_news--block_1.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\themes\\custom\\actadigitech\\templates\\component\\dynamic_content\\news_insights\\views-view-table--in_the_news--block_1.html.twig");
    }
