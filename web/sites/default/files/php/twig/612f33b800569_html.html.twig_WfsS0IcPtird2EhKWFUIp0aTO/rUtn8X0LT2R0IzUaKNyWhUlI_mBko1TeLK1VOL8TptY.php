...
class __TwigTemplate_b8b5e711184bd2df6195cd04f6b90355372645007f37c91bcccf1b4ebc6d7220 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html ";
  ...
  <body";
        // line 66
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["body_classes"] ?? null)], "method", false, false, true, 66), "addClass", [0 => ($context["class"] ?? null)], "method", false, false, true, 66), "setAttribute", [0 => "id", 1 => ($context["id"] ?? null)], "method", false, false, true, 66), 66, $this->source), "html", null, true);
        echo ">
...
";
    ...
    {
        return new Source("", "themes/custom/actadigitech/templates/system/html.html.twig", "/home/actadigitech/all-sites/jd2.jimdetert.com/web/themes/custom/actadigitech/templates/system/html.html.twig");
    }
