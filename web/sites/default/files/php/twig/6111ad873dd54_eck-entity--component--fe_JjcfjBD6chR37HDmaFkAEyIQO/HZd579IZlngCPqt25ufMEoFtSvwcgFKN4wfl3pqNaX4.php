...
class __TwigTemplate_3ae66b68cb85e289961530f5bd0029be32041e6df013dff9c33f334319f89bd1 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"content_width_plus_padding\">
    <div class=\"content_width\">
      <div class=\"guide-block__content\">
        ...
        echo "\" class=\"btn btn_secondary btn_icon\">
          ";
        // line 22
...
{% set body_title = eck_entity.title.value %}
{% set image_url = eck_entity.field_side_image.entity.uri.value %}


{% set link_url = eck_entity.field_download_link.0.url %}
{% set link_text = eck_entity.field_download_link.0.title %}

{% set classes = [
'guide-block guide-block_planning',
] %}
...
<section{{ attributes.addClass(classes) }}>
  ...
  <div class=\"content_width_plus_padding\">
    <div class=\"content_width\">
      <div class=\"guide-block__content\">
        <h3>{{ body_title }}</h3>
        {{ body|raw }}
        <a href=\"{{ link_url }}\" class=\"btn btn_secondary btn_icon\">
          {{ link_text }}
          <img src=\"/themes/custom/actadigitech/images/download-blue.svg\" alt=\"\">
        </a>
        <div class=\"guide-block__image\">
  ...
  ", "themes/custom/actadigitech/templates/component/featured_lhs_image/eck-entity--component--featured_lhs_image_.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\themes\\custom\\actadigitech\\templates\\component\\featured_lhs_image\\eck-entity--component--featured_lhs_image_.html.twig");
    }
