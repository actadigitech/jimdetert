...
/* themes/custom/actadigitech/templates/block/block--system-branding-block.html.twig */
class __TwigTemplate_03623b1bee720edb0508290b0b6970c0d43ac8c53f9f36c7da934ee0d9bb5469 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("block--bare.html.twig", "themes/custom/actadigitech/templates/block/block--system-branding-block.html.twig", 1);
  ...
  ";
        ...
        if (($context["site_name"] ?? null)) {
            // line 25
            echo "    <strong class=\"site_name\"><a href=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->getPath("<front>"));
            echo "\" title=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Home"));
            echo "\" rel=\"home\">";
  ...
  ";
    ...
    {
        return "themes/custom/actadigitech/templates/block/block--system-branding-block.html.twig";
    }
...
{% block content %}
  ...
  {% endif %}
  {% if site_name %}
    <strong class=\"site_name\"><a href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\">{{ site_name }}</a></strong>
  {% endif %}
  {% if site_slogan %}
    <p class=\"navbar-text\">{{ site_slogan }}</p>
  {% endif %}
{% endblock %}
", "themes/custom/actadigitech/templates/block/block--system-branding-block.html.twig", "/var/www/html/jimdetert/web/themes/custom/actadigitech/templates/block/block--system-branding-block.html.twig");
    }
