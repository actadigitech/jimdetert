...
{% set mimage_url = eck_entity.field_mobile_image.entity.uri.value %}
{% set mimage_alt = eck_entity.field_mobile_image.entity.uri.value %}
...
<div{{ attributes.addClass(classes) }}>
  ...
  <div class=\"intro__top\">
    ...
    <div class=\"intro__image-block\">
      <img src=\"{{ file_url(mimage_url) }}\"  alt=\"Jim Detert's book, 'Choosing Courage: The Everyday Guide to Being Brave at Work'\">
    </div>
  </div>
  <div class=\"intro__bottom\">
    <div class=\"intro__order-text\">
