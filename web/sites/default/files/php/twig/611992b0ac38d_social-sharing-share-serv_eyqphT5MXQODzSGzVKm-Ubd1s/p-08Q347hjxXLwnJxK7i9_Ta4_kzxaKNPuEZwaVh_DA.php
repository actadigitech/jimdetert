...
class __TwigTemplate_fd5b50e538108024ea6049d43526d1706fe4b1be82bfb4b1d5d6b1075f30b218 extends \Twig\Template
{
    private $source;
    private $macros = [];
 ...
 *
 * Available variables:
 * - share_services: Array of share services.
 *   - id: Share service id.
 *   - name: Name text.
...
<ul{{ attributes.addClass(classes) }}>
  {% for share_service in share_services %}
    <li>
      <a id=\"{{ 'share-service-' ~ share_service.id }}\" class=\"share-service-link {{ 'share-service-' ~ share_service.id }}\" target=\"_blank\" href=\"{{ share_service.url }}\" title=\"{{ share_service.name }}\" rel=\"noopener noreferrer\">
        <span class=\"share-service-name\">{{ share_service.name }}</span>
      </a>
    </li>
  {% endfor %}
</ul>
", "modules/contrib/social_sharing/templates/social-sharing-share-services.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\modules\\contrib\\social_sharing\\templates\\social-sharing-share-services.html.twig");
    }
