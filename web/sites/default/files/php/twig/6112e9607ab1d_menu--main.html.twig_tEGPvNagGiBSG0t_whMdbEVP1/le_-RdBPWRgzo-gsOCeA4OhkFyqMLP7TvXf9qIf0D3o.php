...
/* themes/custom/actadigitech/templates/menu/menu--main.html.twig */
class __TwigTemplate_f2fc244ed113674b67a9447b6982b708b524c901ff4f9e1c07f5e2104badc1ac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 63
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_call_macro($macros["_self"], "macro_menu_links", [($context["items"] ?? null), ($context["attributes"] ?? null), 0, ((($context["classes"] ?? null)) ? (($context["classes"] ?? null)) : ([0 => "menu", 1 => ("menu--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["menu_name"] ?? null), 63, $this->source))), 2 => "nav"])), ((($context["dropdown_classes"] ?? null)) ? (($context["dropdown_classes"] ?? null)) : ([0 => "sub-nav"]))], 63, $context, $this->getSourceContext()));
        echo "
";
    }
...
$context["item"], "is_expanded", [], "any", false, false, true, 31) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 31))) ? ("item-expanded") : ("")), 1 => ((twig_get_attribute($this->env, $this->source,                     // line 32
...
$context["loop"], "last", [], "any", false, false, true, 34)) ? ("last") : (""))];
        ...
        ";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 46)) {
                        ...
                        echo "
          <div class=\"item-expanded__arrow\">
            <i></i>
          </div>
        ";
                    }
  ...
  ";
    ...
    {
        return "themes/custom/actadigitech/templates/menu/menu--main.html.twig";
    }
    ...
    {
        return array (  161 => 54,  146 => 52,  137 => 47,  135 => 46,  130 => 45,  128 => 44,  125 => 43,  122 => 42,  116 => 41,  113 => 40,  110 => 39,  108 => 38,  103 => 37,  101 => 34,  100 => 33,  99 => 32,  98 => 31,  97 => 30,  95 => 29,  93 => 27,  91 => 26,  74 => 25,  69 => 24,  66 => 23,  49 => 22,  43 => 63,  40 => 57,);
    }
...
{% macro menu_links(items, attributes, menu_level, classes, dropdown_classes) %}
  {% if items %}
    ...
    {% for item in items %}
      ...
      {%
        set item_classes = [
          item.is_expanded and item.below ? 'item-expanded',
...
#}
{{ _self.menu_links(items, attributes, 0, classes ?: ['menu', 'menu--' ~ menu_name|clean_class, 'nav'], dropdown_classes ?: ['sub-nav']) }}
", "themes/custom/actadigitech/templates/menu/menu--main.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\themes\\custom\\actadigitech\\templates\\menu\\menu--main.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("macro" => 22, "if" => 23, "for" => 25, "set" => 27);
        static $filters = array("clean_class" => 63, "escape" => 24, "split" => 27);
