...
class __TwigTemplate_e76672d93b5c1e627d07e69c0ebcf3a64271bff9f9694466208fd651cc30f8b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% set items = eck_entity.field_add_content %}
      ...
      <div class=\"tabset-block\">
        <ul class=\"tabset\">
          {% for key,subentity in items if key|first != '#' %}
            <li class=\"\">
              <a href=\"#tab-{{ subentity.entity.id.value }}\">{{ subentity.entity.title.value }}</a>
            </li>
          {% endfor %}
        </ul>
      </div>
...
<section class=\"opportunities-section white\">
  <div class=\"narrow_width_plus_padding\">
    <div class=\"narrow_width s_inner\">
      <div class=\"tab-content\" style=\"\">
        {% for key,subentity in items if key|first != '#' %}
          <div id=\"tab-{{ subentity.entity.id.value }}\" class=\"tab\" style=\"\">
...
", "themes/custom/actadigitech/templates/component/tab_component/eck-entity--component--tab_component.html.twig", "D:\\xampp\\htdocs\\jimdetert\\web\\themes\\custom\\actadigitech\\templates\\component\\tab_component\\eck-entity--component--tab_component.html.twig");
    }
